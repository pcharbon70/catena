...
IO.puts("foreign_float_probe: 4 finite patterns preserved; 3 NIF and 3 ETF nonfinite patterns refused")

{:ok, nested} = Catena.Foreign.Codec.new({:data, {:record, %{"payload" => {:tuple, [:integer, :text, :bytes]}}}})
