defmodule Catena.LanguageVersionTest do
  ...
  test "prototype slices use one ordered 0.1 patch sequence" do
    ...
    assert LanguageVersion.compilable_revisions() ==
             ~w(0.1.1 0.1.2 0.1.3 0.1.4 0.1.5 0.1.6 0.1.7 0.1.8 0.1.50 0.1.51 0.1.52 0.1.53 0.1.55 0.1.56 0.1.58)
    ...
    assert LanguageVersion.artifact_versions() ==
             LanguageVersion.interface_versions() ++
               ["0.1.50", "0.1.51", "0.1.52", "0.1.53", "0.1.55", "0.1.56", "0.1.58"]
    ...
    assert LanguageVersion.compilable_from(:specifications_and_governance) ==
             ~w(0.1.6 0.1.7 0.1.8 0.1.50 0.1.51 0.1.52 0.1.53 0.1.55 0.1.56 0.1.58)

    assert LanguageVersion.latest() == "0.1.58"
