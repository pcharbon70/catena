defmodule Catena.C027EntryPointsTest do
  ...
  @frontends ~w(0.1.9 0.1.10 0.1.11 0.1.12 0.1.13 0.1.14 0.1.15 0.1.16 0.1.17 0.1.18 0.1.19 0.1.20 0.1.21 0.1.22 0.1.23)
  ...
  test "0.1.23 is an exact registered revision with predecessors pinned" do
    ...
    assert {:ok, %{selection: %{language_revision: "0.1.23"}}} = Catena.decode_source_text("")
