...
```catena
-- Package.catena file (required at project root)
package {
  name: "catena_web",
  version: "1.2.3",
  ...
  links: {
    github: "https://github.com/catena-lang/catena_web",
    documentation: "https://hexdocs.pm/catena_web",
    changelog: "https://github.com/catena-lang/catena_web/blob/main/CHANGELOG.md"
  },
  
  -- Dependencies from Hex.pm (Catena, Elixir, or Erlang packages)
  deps: {
    catena_core: "~> 2.1",
    jason: "~> 1.4",  -- Can use Elixir packages!
    cowboy: "~> 2.9",  -- And Erlang packages!
    catena_test: "~> 1.0" only: [test]
  },
  ...
  docs: {
    ...
    hexdocs: {
      source_url: "https://github.com/catena-lang/catena_web",
      source_ref: version,
      extras: ["README.md", "CHANGELOG.md", "guides/getting-started.md"],
      groups_for_modules: {
        "Core": [CatenaWeb.Router, CatenaWeb.Controller],
        "Middleware": [CatenaWeb.Auth, CatenaWeb.CORS],
        "Testing": [CatenaWeb.Test, CatenaWeb.MockClient]
      },
  ...
  -- Minimum Catena version required
  requires: "catena ~> 1.0"
}
```
...
$ catena package init
Creating new Catena package...
Package name: my_lib
Version: 0.1.0
Description: My awesome library
License: MIT
✓ Created Package.catena
✓ Created lib/
✓ Created test/
✓ Created README.md

# Add dependencies
$ catena deps add catena_web ~> 1.2
✓ Added catena_web ~> 1.2 to Package.catena
✓ Running dependency resolution...
✓ Fetched catena_web 1.2.3
✓ Fetched catena_core 2.1.0 (transitive)
...
# Update dependencies
$ catena deps update catena_web
Updating catena_web...
✓ Updated catena_web from 1.2.3 to 1.2.5
...
$ catena package validate
Validating package my_lib v0.1.0...
✓ Package.catena is valid
...
$ catena package retire 0.1.0 --reason "Critical bug in API"
...
doc """
  CatenaWeb is a functional web framework built on category theory.
...
module DocGen = {
  ...
  -- Convert Catena doc syntax to ExDoc/HexDocs format
...
```catena
-- Using Elixir packages in Catena
import Jason  -- Elixir JSON library

doc "Serialize data to JSON using Elixir's Jason library"
flow to_json : a -> Result Text Error
flow to_json data =
  -- Automatic conversion between Catena and Elixir types
  data
  |> to_elixir_term  -- Convert Catena types to Elixir
  |> Jason.encode
  |> from_elixir_result  -- Convert back to Catena Result

-- Using Erlang packages
import :cowboy  -- Erlang web server

doc "Start Cowboy web server with Catena handlers"
...
-- Exposing Catena modules for Elixir/Erlang use
doc "Export this module as an Erlang behavior"
export_erlang behaviour: true, app: :catena_app
module CatenaServer = {
  -- Catena functions callable from Elixir/Erlang
...
-- GitHub Actions workflow generated by Catena
  ...
  jobs:
    test:
      ...
      steps:
        ...
        - uses: catena-lang/setup-catena@v1
          with:
            catena-version: '~> 1.0'
        - run: catena deps get
        - run: catena test
        - run: catena docs build
        - run: catena package validate
  """
```
...
-- Lock file for reproducible builds (catena.lock)
lock {
  catena_web: {
    version: "1.2.3",
...
/*
my_package/
├── Package.catena          # Package metadata
├── catena.lock            # Locked dependencies
...
import CatenaWeb.Router as WebRouter
...
package {
  ...
  hex: {
    ...
    auth: {
      method: "key",
      key_name: "CATENA_HEX_KEY"  -- From environment
    }
  },
...
-- $ catena package publish --organization mycompany
```
...
4. **Package.catena**: Central package configuration file
...
:This design ensures Catena packages integrate seamlessly with the existing BEAM ecosystem while maintaining the language's functional and categorical principles. The documentation system produces HexDocs-compatible output automatically, making every Catena package immediately accessible to the wider community.
