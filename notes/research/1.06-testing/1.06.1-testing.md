...
watch_config {
  ...
  before_run: ["catena compile --warnings-as-errors"]
}
...
This integrated testing framework makes testing not just easy but unavoidable - it's part of writing Catena code. The tight integration with the type system and documentation means tests are always up-to-date and comprehensive.
