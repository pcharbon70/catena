...
| `SCN-008` | Exercise Internal Property Testing | The internal property-testing framework supports the implemented rose-tree and generator/seed layers while clearly marking later generator-instance and runner work as pending. |
