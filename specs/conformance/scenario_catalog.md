...
| `SCN-008` | Exercise Internal Property Testing | The internal property-testing framework supports the implemented rose-tree, generator/seed, categorical-generator, primitive-combinator, and range layers while clearly marking fuller shrinking and runner work as pending. |
