...
| `SCN-008` | Exercise Internal Property Testing | The internal property-testing framework supports the implemented rose-tree, generator/seed, categorical-generator, primitive-combinator, range, and shrink-search layers while clearly marking runner and fuller integration work as pending. |
