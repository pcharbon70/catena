...
| `REQ-STDLIB-*` | `specs/contracts/stdlib_contract.md` | `SCN-002`, `SCN-004`, `SCN-007`, `SCN-008` |
| `REQ-TEST-*` | `specs/contracts/testing_and_quality_contract.md` | `SCN-007`, `SCN-008`, `SCN-009` |
...
| `specs/stdlib/standard_library_surface.md` | `REQ-STDLIB-*`, `REQ-COMP-*` | `SCN-002`, `SCN-003`, `SCN-007` |
| `specs/stdlib/property_testing_framework.md` | `REQ-STDLIB-*`, `REQ-TEST-*` | `SCN-008`, `SCN-009` |
