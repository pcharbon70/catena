...
| --- | --- | --- |
| `REQ-COMP-*` | `specs/contracts/compiler_contract.md` | `SCN-001`, `SCN-002`, `SCN-003`, `SCN-006`, `SCN-007`, `SCN-011` |
...
| `REQ-TEST-*` | `specs/contracts/testing_and_quality_contract.md` | `SCN-007`, `SCN-008`, `SCN-009`, `SCN-010`, `SCN-011` |
