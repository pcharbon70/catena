...
- `REQ-STDLIB-003`: Test and law-verification surfaces MUST remain expressible as Catena library modules, even when their execution or verification depth is still partial. Law verification SHOULD support a staged path from pure law definitions and concrete `Test.verify` suites toward generator-backed generic law suites as the internal property-testing framework matures.
