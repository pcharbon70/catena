...
| --- | --- | --- | --- | --- |
| `REQ-COMP-*` | [compiler_contract.md](compiler_contract.md) | compiler pipeline, semantic normalization, typing, effects, fail-closed Core Erlang/BEAM backend, call resolution, imports | [../compiler/core_compiler_pipeline.md](../compiler/core_compiler_pipeline.md), [../compiler/core_erlang_and_beam_backend.md](../compiler/core_erlang_and_beam_backend.md), [../compiler/type_and_effect_system.md](../compiler/type_and_effect_system.md), [../compiler/pattern_matching_engine.md](../compiler/pattern_matching_engine.md) | `SCN-001`, `SCN-002`, `SCN-003`, `SCN-006`, `SCN-007`, `SCN-011` |
