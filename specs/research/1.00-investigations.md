# Critical Missing Features for Catena
...
- **Polycatena variants** - Open sum types
...
These missing features represent the gap between our current Catena design and a fully production-ready language. Some are essential for real-world use (like proper error handling and FFI), while others would enhance developer experience or enable specific use cases. The priority would depend on Catena's intended primary use cases and target audience.
