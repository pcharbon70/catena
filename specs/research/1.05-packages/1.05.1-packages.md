...
```catena
-- Package.cat file (required at project root)
package {
  name: "catena_web",
  version: "1.2.3",
...
✓ Added catena_web ~> 1.2 to Package.cat
...
4. **Package.cat**: Central package configuration file
