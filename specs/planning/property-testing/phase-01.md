...
- [x] **Integration Tests 1.7 Complete**
...
- [x] Test composing multiple generators with `gen_map`, `gen_ap`, `gen_bind`
- [x] Test generating complex values (pairs, triples, nested structures)
- [x] Test shrinking composed values finds minimal cases
- [x] Test reproducibility: same seed produces identical results
- [x] Test size scaling affects generation appropriately
- [x] Test range-based generation with various scaling functions
- [x] Test categorical laws hold for composed generators
- [x] Test performance: generating 10000 values completes in < 1 second
- [x] Test memory: generating values doesn't leak (children evaluated lazily)
- [x] Test interoperability with Erlang data types (atoms, tuples, maps)
