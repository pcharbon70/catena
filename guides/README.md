...
through 0.1.19 provide the strict source envelope, standalone Unicode name
...
Versions 0.1.1 through 0.1.19 identify completed normative revision boundaries;
