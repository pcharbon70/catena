defmodule Catena.LanguageVersion do
  ...
  @versions [
    ...
    numeric_library: "0.1.67",
    environmental_effects: "0.1.68",
    minimum_prelude: "0.1.69",
    trusted_computing_base: "0.1.70",
    trusted_obligation_policy: "0.1.71",
    secrets_and_capabilities: "0.1.72",
    reproducible_builds: "0.1.73",
    supply_chain_policy: "0.1.74",
    resource_exhaustion: "0.1.75",
    distribution: "0.1.76",
    message_semantics: "0.1.77",
    scheduler_observability: "0.1.78",
    hot_code_upgrade: "0.1.79",
    long_term_evolution: "0.1.80",
    build_system: "0.1.81",
    compatibility_suite: "0.1.82",
    reference_evaluator: "0.1.83",
    testing_tools: "0.1.84",
    differential_testing: "0.1.85",
    optimizer_validity: "0.1.86",
    standard_stability_and_performance: "0.1.87",
    performance_envelope: "0.1.88",
    debugging_and_observability: "0.1.89",
    release_readiness: "0.1.90",
    diagnostic_contract: "0.1.91",
    documentation_tool: "0.1.92"
  ]
  @ordered Keyword.values(@versions)
  @json_frontends ~w(0.1.1 0.1.2 0.1.3 0.1.4 0.1.5 0.1.6 0.1.7)
  @kernel_frontends ~w(0.1.8)
  @source_text_frontends ~w(0.1.9 0.1.10 0.1.11 0.1.12 0.1.13 0.1.14 0.1.15 0.1.16 0.1.17 0.1.18 0.1.19 0.1.20 0.1.21 0.1.22 0.1.23 0.1.24 0.1.25 0.1.26 0.1.27 0.1.28 0.1.29 0.1.30 0.1.31 0.1.32 0.1.33 0.1.34 0.1.35 0.1.36 0.1.37 0.1.38 0.1.39 0.1.40 0.1.41 0.1.42 0.1.43 0.1.44 0.1.45 0.1.46 0.1.47 0.1.48 0.1.49 0.1.50 0.1.51 0.1.52 0.1.53 0.1.54 0.1.55 0.1.56 0.1.57 0.1.58 0.1.59 0.1.60 0.1.61 0.1.62 0.1.63 0.1.64 0.1.65 0.1.66 0.1.67 0.1.68 0.1.69 0.1.70 0.1.71 0.1.72 0.1.73 0.1.74 0.1.75 0.1.76 0.1.77 0.1.78 0.1.79 0.1.80 0.1.81 0.1.82 0.1.83 0.1.84 0.1.85 0.1.86 0.1.87 0.1.88 0.1.89 0.1.90 0.1.91 0.1.92)
  ...
  @numeric_frontends ~w(0.1.67)
  @environment_frontends ~w(0.1.68)
  @secret_frontends ~w(0.1.72)
  @compilable @json_frontends ++
                ...
                @debug_frontends ++
                @text_frontends ++
                @numeric_frontends ++ @environment_frontends ++ @secret_frontends
  ...
  @type feature ::
          ...
          | :optimizer_validity
          | :standard_stability_and_performance
  ...
  def secret_frontend_versions, do: @secret_frontends
  ...
  def artifact_versions,
    do:
      @interfaces ++
        ...
        @foreign_frontends ++
        @debug_frontends ++
        @text_frontends ++ @numeric_frontends ++ @environment_frontends ++ @secret_frontends
