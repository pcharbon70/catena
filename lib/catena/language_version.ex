defmodule Catena.LanguageVersion do
  ...
  @compilable @json_frontends ++ @kernel_frontends ++ @capability_frontends ++ @resource_frontends
  ...
  def artifact_versions, do: @interfaces ++ @capability_frontends ++ @resource_frontends
