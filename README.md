...
The rewrite has been initialized, but no compiler implementation or build
system has been selected yet. Build, test, and contribution instructions will
be added alongside the new architecture.
