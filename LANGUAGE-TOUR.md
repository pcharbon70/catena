...
library territory (G101); references stay excluded (G084).
...
20. [`c037_observability_test.exs`](test/catena/c037_observability_test.exs) —
   ...
   boundary.
21. [`c038_compile_time_test.exs`](test/catena/c038_compile_time.exs) —
   derived folds with `compiler_derived` provenance recompiling
   byte-identically, the three budget regressions, and the absence
   matrix.
22. [`c040_data_model_test.exs`](test/catena/c040_data_model_test.exs) —
